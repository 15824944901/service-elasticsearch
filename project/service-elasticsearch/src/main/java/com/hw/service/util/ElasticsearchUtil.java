...
public class ElasticsearchUtil {
    ...
    public static boolean deleteIndex(String index) {
        ...
        AcknowledgedResponse deleteresponse = client.admin().indices().prepareDelete(index).execute().actionGet();
     ...
     * @return 分页
     */
    public static ElasticSearchPage searchDataPage(String index, String type, int startPage, int pageSize, QueryBuilder query, String fields, String sortField, String highlightField) {
    ...
    public static List<Map<String, Object>> searchListData(
        String index, String type, QueryBuilder query,int startPage, int pageSize,
        ...
        if (StringUtils.isNotEmpty(sortField)) {
            searchRequestBuilder.addSort(SortBuilders.fieldSort(sortField).unmappedType("String").order(SortOrder.DESC));
        }
     ...
     * @param highlightField  highlightField
     * @return List
     */
    private static List<Map<String, Object>> setSearchResponse(SearchResponse searchResponse, String highlightField) {
        List<Map<String, Object>> sourceList = new ArrayList<Map<String, Object>>(10);
